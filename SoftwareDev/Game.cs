...
namespace SoftwareDev
{
    class Game
    {
        ...
        private List<GameButton> oButton = new List<GameButton>();
        ...
        public Game()
        {
            ...
            oButton.Add(new GameButton(18, 18, 125, 130, 0, true));  // -- LEFT BIG

            oButton.Add(new GameButton(161, 18, 100, 66, 1, false)); // -- SCORE
            oButton.Add(new GameButton(279, 18, 100, 66, 1, false)); // -- BEST

            oButton.Add(new GameButton(161, 96, 100, 38, 2, true));  // -- NEW GAME
            oButton.Add(new GameButton(279, 96, 100, 38, 2, true));  // -- ABOUT

            oButton.Add(new GameButton(64, 103, 32, 32, 9, true)); // -- S
            oButton.Add(new GameButton(64, 30, 32, 32, 9, true));  // -- W
            oButton.Add(new GameButton(30, 67, 32, 32, 9, true));  // -- A
            oButton.Add(new GameButton(97, 67, 32, 32, 9, true));  // -- D
        ...
        public void Update()
        {
            ...
            {
                int nX = oR.Next(0, 4), nY = oR.Next(0, 0);
        ...
        public void DrawGame(Graphics g)
        {
            ...
            DrawTextCenterX(g, "2048 Game", fFontS2, new SolidBrush(Color.FromArgb(120, 110, 101)), 198, 552);
            DrawTextCenterX(g, "HBD Consulting LLP", fFontS2, new SolidBrush(Color.FromArgb(120, 110, 101)), 198, 566);
        }
        ...
        public void DrawAbout(Graphics g)
        {
            ...
            DrawTextCenterXWS(g, "Author: Bhavik Desai", fFontS, new SolidBrush(Color.FromArgb(255, 10, 10, 10)), new SolidBrush(Color.White), 198, 250);

            DrawTextCenterXWS(g, "HBD Consulting LLP", fFontS, new SolidBrush(Color.FromArgb(255, 10, 10, 10)), new SolidBrush(Color.White), 198, 350);
            DrawTextCenterXWS(g, "01-11-2020", fFontS, new SolidBrush(Color.FromArgb(255, 10, 10, 10)), new SolidBrush(Color.White), 198, 370);
        }
